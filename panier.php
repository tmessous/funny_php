...
if(isset($_POST['payer']))
{
	...
	if(!isset($erreur))
	{
		...
		unset($_SESSION['panier']);
		mail($_SESSION['membre']['email'], "confirmation de la commande", "Merci votre numéros de suivi est le $id_commande", "From:vendeur@dp_site.com");
		$contenu .= "<div class='validation'>Merci pour votre commande. votre numéros de suivi est le $id_commande</div>";
	}
}
...
echo "</table><br />";
echo "<i>Réglement par CHEQUE uniquement à l'adresse suivante : 300 rue de vaugirard 75015 PARIS</i><br />";
