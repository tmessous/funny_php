...
{	// debug($_POST);
	...
	executeRequete("REPLACE INTO produit (id_produit, reference, categorie, titre, description, editeur, age, photo, prix, tva, stock) values ('$_POST[id_produit]', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$_POST[editeur]', '$_POST[age]', '$photo_bdd',  '$_POST[prix]', '$_POST[public]', '$_POST[stock]')");
